...
var keyCode = event.keyCode ? event.keyCode : event.which ? event.which : event.charCode;
	...
	<table cellspacing="10" width="100%">
             <tr>   
<td width="100%" style="font-size:14px; font-weight:bold"><a href="http://web-dorado.com/spider-contacts-wordpress-guide-step-3.html" target="_blank" style="color:blue; text-decoration:none;">User Manual</a><br />
This section allows you to create Contacts. <a href="http://web-dorado.com/spider-contacts-wordpress-guide-step-3.html" target="_blank" style="color:blue; text-decoration:none;">More...</a></td>   
